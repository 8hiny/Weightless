...
public abstract class EntityMixin {
    ...
    private void preventFall(Entity entity, double d, boolean onGround, BlockState blockState, BlockPos blockPos, Operation<Void> original) {
        original.call(
                entity,
                d,
                onGround && !(entity instanceof Player player && WeightlessComponent.flying(player)),
                blockState,
                blockPos
        );
    }
